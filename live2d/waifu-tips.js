...
const live2d_settings = {
    // 基本设置
    'modelUrl': 'https://jackylee06.github.io/live2d/model',                        // 存放模型的文件夹路径，末尾不需要斜杠
    ...
    'homePageUrl': 'https://jackylee06.github.io/',  // 主页地址，可选 'auto'(自动), '{URL 网址}'
    'aboutPageUrl': 'https://jackylee06.github.io/about/', // 关于页地址, '{URL 网址}'
